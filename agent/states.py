...
# Defining data models for structured outputs: File class
...
# Defining data models for structured outputs: Plan
class Plan(BaseModel):
    ...
    techstack: str = Field(description = "The tech stack to be used for the app, e.g. 'python', 'javascript', 'react', 'tailwind css', 'flask', etc.", default = "React + Tailwind CSS")
...
# Defining data models for structured outputs: ImplementationTask
...
# Defining data models for structured outputs: TaskPlan
class TaskPlan(BaseModel):
    plan: str = Field(description = "High-level plan description")
    implementation_steps: list[ImplementationTask] = Field(description = "A list of steps to be taken to implement the task")
    model_config = ConfigDict(extra = "forbid")
    
# Defining data models for structured outputs: CoderState
